...
export default {
  ...
  methods: {
    addpost() {
      ...
      console.log(user_id)
      this.$router.push({ name: 'post', query: { user_id: user_id } })
    },
    export_post() {
      const user_id = this.$route.query.user_id
      fetch("http://127.0.0.1:5000/api/export/" + user_id, {
        method: "GET",
    ...
    editprofile(){
      const user_id = this.$route.query.user_id
      this.$router.push({ name: 'EditProfile', query: { user_id: user_id } })

    },
    editpost(post_id){
      const user_id = this.$route.query.user_id
      this.$router.push({ name: 'EditPost', query: { user_id: user_id ,post_id :  post_id} })
    },
    delete1(post_id){
  ...
  <div>
    <nav class="navbar">
      ...
      <ul class="navbar-menu">
        ...
        <li v-on:click="addpost">Add Post</li>
        <li v-on:click="f">Add Friend</li>
        <li v-on:click="export_post">export</li>
    ...
    <div class="profile-container">
      <div class="profile-header">
        ...
        <div class="profile-info">
          ...
          <span>{{ bio }}</span>
          <button class="profile-edit-button" v-on:click="editprofile">Edit Profile</button>
        </div>
      </div>
